...
versioned SDK release. CLI `v0.2.2-alpha.1` targets Go SDK
...
`v0.2.2-alpha.1`, is an output-only feature. It encodes the already-formatted
private link and does not change message IDs, secrets, derivation, encryption, or
the backend API.
